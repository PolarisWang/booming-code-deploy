...
6. **编写设计文档** — 保存到 `docs/booming/specs/YYYY-MM-DD-<topic>-design.md` 并提交
...
- 将经过验证的设计（规格）写入 `docs/booming/specs/YYYY-MM-DD-<topic>-design.md`
  - （用户对规格位置的偏好覆盖此默认值）
...
`skills/booming-code-brainstorm/visual-companion.md`
